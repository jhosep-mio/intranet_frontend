                        ...
                        <div className="mb-3 col-md-11">
                            ...
                            <div className='content_general mb-3 col-md-12'>
                                ...
                                <div className="mb-3 col-md-3 div_conten2">
                                    ...
                                    <input value={varon} type="checkbox" className='on_active' onChange={(e) => setVaron(e.target.checked)} checked={varon} />
                                    <span className="">F</span>
                                    <input value={mujer} type="checkbox" className='on_active' onChange={(e) => setMujer(e.target.checked)} checked={mujer}/>
                                </div>

                                <div className="mb-3 col-md-4 div_conten">
                                    <label className="label_title">Telefono: </label>
                                    <input className="form-control form-control3 form-control2" autoFocus required
                                        value={celular}
                                        type="text"
                            ...
                            <div className='content_general mb-3 col-md-12'>
                                ...
                                <div className="mb-3 col-md-6 div_conten">
                                    ...
                                    <input className="form-control form-control3 form-control2" required
                                        value={emailOdon}
                                        type="text"
